...
crayons = list(
  ...
  metallic_fx = structure(c(
    alloy_orange = '#C46210',
    b_dazzled_blue = '#2E5894', big_dip_o_ruby = '#9C2542',
  ...
  modern = structure(c(scarlet = "#FD0E35", sunset_orange = "#FE4C40", vivid_tangerine = "#FF9980",
                       ...
                       purple_mountains_majesty = "#9678B6", fuchsia = "#C154C1", pink_flamingo = "#FC74FD",
  ...
  no_64 = structure(c(red = "#ED0A3F", maroon = "#C32148", brick_red = "#CB4154",
                      ...
                      green = "#008001", pine_green = "#01796F", light_blue = "#ADD8E6",
  ...
  standard64 = structure(c(
    ...
    purple_mountains_majesty = '#D6AEDD', plum = '#8E3179',
    red_violet = '#BB3385', magenta = '#F653A6', wild_strawberry = '#FF3399',
    lavender_ii = '#FBAED2', carnation_pink = '#FFA6C9', violet_red = '#F7468A',
    ...
    apricot = '#FDD5B1', gold_ii = '#E6BE8A', silver = '#C9C0BB',
    black = '#000000', gray = '#8B8680', timberwolf = '#D9D6CF',
    white = '#FFFFFF'
  ), class = c('palette', 'character')),
