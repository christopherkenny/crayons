...
#'
#' @examples
#' print(crayons$billionth)
#' print(crayons$color_n_smell)
#' print(crayons$colors_of_the_world)
#' print(crayons$construction_paper)
#' print(crayons$fluorescent)
#' print(crayons$gel_fx)
#' print(crayons$gem_tones)
#' print(crayons$heads_n_tails)
#' print(crayons$magic_scent)
#' print(crayons$metallic_fx)
#' print(crayons$mini_twistables)
#' print(crayons$modern)
#' print(crayons$munsell)
#' print(crayons$multicultural)
#' print(crayons$no_48)
#' print(crayons$no_64)
#' print(crayons$original)
#' print(crayons$pearl)
#' print(crayons$pearl_brite)
#' print(crayons$silly_scents)
#' print(crayons$silver_swirls)
#' print(crayons$standard)
#' print(crayons$standard16)
#' print(crayons$standard24)
#' print(crayons$standard32)
#' print(crayons$standard64)
#' print(crayons$star_brite)
#'
#' @concept colors
#' @export
crayons <- list(
